package com.jimjin.mybucketlist;
...
public class ThingsToDoActivity extends AppCompatActivity {
    ...
    private void setupList() {
        BucketListEntry[] thingsToDo = {
            ...
            new BucketListEntry("Road Trip across USA","Hire a car from the west coast, and travel to the east coast.",R.drawable.road_trip,5),
